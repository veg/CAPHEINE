...
include { HYPHY_FEL } from '/Users/hverdonk/nf-core-capheine/modules/local/hyphy/fel/tests/../main.nf'
...
workflow {
    ...
    if (HYPHY_FEL.output){
        ...
        for (def name in HYPHY_FEL.out.getNames()) {
            serializeChannel(name, HYPHY_FEL.out.getProperty(name), jsonOutput)
        }	  
      
        // consumes all unnamed output channels and stores items in a json file
        def array = HYPHY_FEL.out as Object[]
